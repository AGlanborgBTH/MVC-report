...
/**
 * Three is an class made for asserting wish of two 'characters' contain the highest valued cards
 */
class Three
{
    /**
    ...
    public function result($player, $dealer, $player_hand, $dealer_hand, $table_hand): int
    {
        ...
        if ($asc == 5) {
            return $this->fallback->result($player_hand, $dealer_hand, $table_hand, $player->matching->value, 2);
        } else {
            return $asc;
        }
    }
