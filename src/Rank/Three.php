...
/**
 * Four is an class made asserting if an array of App\Poker\PokerCard consist of 3 of the same points/value value (a Three of a kind)
 */
class Three
{
    /**
     * $matching is an property containing an object for asserting if an array of App\Poker\PokerCard objects contain three of a kind
     *
     * @var object
     */
