...
/**
 * FullHouse is an class made asserting if an array of App\Poker\PokerCard consist of 2 of the same points/value value
 * and another 2 of the same points/value (a Two Pair)
 */
class TwoPair
{
    /**
     * $set is an property containing an object for asserting if an array of App\Poker\PokerCard objects contain a two
     * pair
     *
     * @var object
     */
