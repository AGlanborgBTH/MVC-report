...
/**
 * StraightFlush is an class made asserting if an array of App\Poker\PokerCard consist of 5 or more cards in an ascending order and all of the same group/pattern (a Straight Flush)
 */
class StraightFlush
{
    /**
     * $ascending is an property containing an object for asserting if an array of App\Poker\PokerCard objects contain a in an ascending order
     *
     * @var object
     */
