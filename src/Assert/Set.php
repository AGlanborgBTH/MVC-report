...
/**
 * Set is an class made for asserting if an array of App\Poker\PokerCard objects contain multiple objects who are matching (2 groups/values)
 */
class Set
{
    /**
     ...
     * 
     * @param int $small is the number that will dictate how many the smaller- or equally sized- matching objects must contain
     */
     ...
     * 
     * The method runs the $this->identify method twice, but only if the object contains matching pair that are of the $large count
     * 
     * The method will assign values to the $this->bool and $this->value properties if both the $large and $small amount of matching pairs are forfilled
     * 
     * @param array $stack is the array to be asserted if it contains the objects that are to be compared
     * 
     * @param int $large is the number that will dictate how many the larger matching objects must contain
