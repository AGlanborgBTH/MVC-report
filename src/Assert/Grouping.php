...
class Grouping
{
     ...
     * 
     * The method counts the amount of objects who are in the same group, and if they pass the $num amount, they are saved in the $this->bool- and $this->value-properties
     * 
     * @param array $stack is the array to be asserted if it is grouping
     * 
     * @param int $num is the number of cards the group must have to pass/count
