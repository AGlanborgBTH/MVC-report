...
class Matching
{
     ...
     * 
     * The method counts the amount of objects who are of the same value, and if they pass the $num amount, they are saved in the $this->bool- and $this->value-properties
     * 
